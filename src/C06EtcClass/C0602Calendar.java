...
public class C0602Calendar {
    public static void main(String[] args) {
        ...
        System.out.println(calendar1.get(Calendar.HOUR_OF_DAY)-1);
        ...
        // 임의로 특정시간을 만들어내고 싶을 때 : of 메서드 사용
        LocalDate birthDay = LocalDate.of(2000,1,20);
        System.out.println(birthDay.getYear());
        System.out.println(birthDay.getMonth());
        System.out.println(birthDay.getDayOfMonth());

        LocalTime birthTime = LocalTime.of(20, 20, 30);
